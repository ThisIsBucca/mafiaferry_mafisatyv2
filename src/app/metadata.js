export const defaultMetadata = {
  ...
  twitter: {
    ...
    title: 'MafiaFerry - Your Gateway to Mafia Island',
    description: 'Book your ferry to Mafia Island today. Safe, reliable, and professional service.',
    images: ['https://rmqggozcsfdvemvulmoy.supabase.co/storage/v1/object/public/images//mvkilindoni.jpg'],
  },
  robots: {
    index: true,
    follow: true,
