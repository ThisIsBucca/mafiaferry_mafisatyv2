          ...
          <div className="group relative bg-card/30 backdrop-blur-sm p-8 rounded-2xl border border-border/10 hover:border-primary/20 shadow-lg hover:shadow-primary/5 transition-all duration-300">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-foreground/90 to-foreground/80">{t("contact.phone")}</h3>
              </div>
              ...
              <a 
                href="tel:+255688883219" 
                className="group/link flex items-center gap-2 text-lg font-medium text-primary hover:text-primary/80 transition-colors mt-2"
              >
                +255 688 883 219
                <ExternalLink className="h-4 w-4 opacity-0 -translate-y-1 group-hover/link:opacity-100 group-hover/link:translate-y-0 transition-all duration-300" />
              </a>
          ...
          <div className="group relative bg-card/30 backdrop-blur-sm p-8 rounded-2xl border border-border/10 hover:border-primary/20 shadow-lg hover:shadow-primary/5 transition-all duration-300">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-foreground/90 to-foreground/80">{t("contact.email")}</h3>
              </div>
              <p className="text-muted-foreground/80 mb-4">
          ...
          <div className="group relative bg-card/30 backdrop-blur-sm p-8 rounded-2xl border border-border/10 hover:border-primary/20 shadow-lg hover:shadow-primary/5 transition-all duration-300">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-foreground/90 to-foreground/80">{t("contact.location")}</h3>
              </div>
              <p className="text-muted-foreground/80 mb-4">
          ...
          <div className="group relative bg-card bg-opacity-95 dark:bg-card/90 p-8 rounded-2xl border border-[#25D366]/20 hover:border-[#25D366]/40 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-1">{t("contact.whatsapp_schedule")}</h3>
                  <p className="text-sm text-muted-foreground flex items-center gap-2">
                    <span className="inline-block w-2 h-2 rounded-full bg-[#25D366] shadow-sm shadow-[#25D366]/30"></span>
                    {t("contact.members")} 256
                  </p>
                </div>
              </div>
              <p className="text-muted-foreground mb-6">
                {t("contact.whatsapp_schedule_desc")}
              </p>
              <a 
              ...
              >
                ...
                <span>{t("contact.join_group")}</span>
                <ExternalLink className="h-4 w-4 opacity-0 -translate-y-1 group-hover/link:opacity-100 group-hover/link:translate-y-0 transition-all duration-300" />
              </a>
            </div>
          </div>
          ...
          <div className="group relative bg-card bg-opacity-95 dark:bg-card/90 p-8 rounded-2xl border border-[#25D366]/20 hover:border-[#25D366]/40 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-1">{t("contact.whatsapp_business")}</h3>
                  <p className="text-sm text-muted-foreground flex items-center gap-2">
                    <span className="inline-block w-2 h-2 rounded-full bg-[#25D366] shadow-sm shadow-[#25D366]/30"></span>
                    {t("contact.members")} 124
                  </p>
                </div>
              </div>
              <p className="text-muted-foreground mb-6">
                {t("contact.whatsapp_business_desc")}
              </p>
              <a 
